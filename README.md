...
- `openSeadragon` (object): An object with options for OpenSeadragon, the image rendering component of TIFY. [See its documentation](https://openseadragon.github.io/docs/OpenSeadragon.html#.Options) for all available options.
