describe('Fulltext', () => {
	it('displays fulltext and annotation overlays at the correct positions', () => {
		...
		cy.get('.tify-scan-image [style*="left: 18.8309px; top: 282.988px"]')
			.children('.tify-scan-overlay[style*="width: 113.797px; height: 5.0324px"]');
		cy.get('.tify-scan-image [style*="left: 414.136px; top: 282.988px"]')
			.children('.tify-scan-overlay[style*="width: 113.797px; height: 5.0324px"]');
		cy.get('.tify-scan-image [style*="left: 809.44px; top: 282.988px"]')
			.children('.tify-scan-overlay[style*="width: 113.797px; height: 5.0324px"]');
	});
