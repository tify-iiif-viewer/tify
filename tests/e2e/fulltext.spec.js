describe('Fulltext', () => {
	it('displays fulltext and annotation overlays at the correct positions', () => {
		...
		cy.get('.tify-scan-overlay[style*="left: -183.51px; top: 240.901px; width: 154.04px; height: 6.81205px;"]');
		cy.get('.tify-scan-overlay[style*="left: 351.59px; top: 240.901px; width: 154.04px; height: 6.81205px;"]');
		cy.get('.tify-scan-overlay[style*="left: 886.689px; top: 240.901px; width: 154.04px; height: 6.81205px;"]');
	});
