describe('IIIF Cookbook 0010: Viewing direction', () => {
	it('supports right-to-left manifests', () => {
		cy.visit(
			`/?manifest=${Cypress.expose('iiifApiUrl')}/iiif-cookbook/0010-book-2-viewing-direction/manifest-rtl.json`,
		);
	...
	it('supports top-to-bottom manifests', () => {
		cy.visit(
			`/?manifest=${Cypress.expose('iiifApiUrl')}/iiif-cookbook/0010-book-2-viewing-direction/manifest-ttb.json`,
		);
